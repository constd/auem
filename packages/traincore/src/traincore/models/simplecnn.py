...
DEFAULT_CONV_LAYER_DEF: list[tuple[int, int, tuple[int, ...]]] = [
    (8, 7, (2,)),
    (16, 5, (1, 2)),
    (32, 3, (1, 2)),
    (32, 4, (2, 3)),
...
class SimpleCNNBase(AuemClassifierBase):
    ...
    def __init__(
        ...
        for layer_def in conv_layer_def:
            ...
            conv_layers.append(module=nn.BatchNorm2d(layer_def[0]))
            conv_layers.append(module=nn.ReLU())
        ...
        for layer_def in dense_layer_def:
            ...
            dense_layers.append(module=nn.ReLU())

        self.convs = nn.Sequential(*conv_layers)
        self.dense = nn.Sequential(*dense_layers)
        # self.embedding_model = nn.Sequential(*conv_layers, *dense_layers)
