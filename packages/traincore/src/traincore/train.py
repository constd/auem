...
# def datasets(cfg: DictConfig) -> tuple[Dataset, Dataset]:
#     """Create dataset objects using the config."""
#     transforms = hydra.utils.instantiate(cfg.transform)
#     ds_train: Dataset = hydra.utils.get_class(cfg.dataset["class"])(
#         audioset_annotations=cfg.dataset["folds"]["train"],
#         transforms=transforms,
#         **cfg.dataset.params,
#     )
#     ds_valid: Dataset = hydra.utils.get_class(cfg.dataset["class"])(
...
#     dl_train: DataLoader = hydra.utils.get_class(cfg.dataloader["class"])(
#         ds_train, **cfg.dataloader.params
#     )
#     dl_valid: DataLoader = hydra.utils.get_class(cfg.dataloader["class"])(
